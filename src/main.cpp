...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    if(nHeight < 100) // vorher no block reward within the first 3 days
        nSubsidy = 1000000;
    if(nHeight > 100) // vorher no block reward after 5 years
        nSubsidy = 2000;
...
static const int64 nTargetSpacing = 60; // samcoin: 60 seconds
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0c6c03d488bb452acc90d6785550f1fd36a7b6d47cae300953cc4aa3036b88ff");
    }
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "We are so cool and eloquent...";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1398280909;   ////    1366559428;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 0;    /////2085386442;

        if (fTestNet)
        {
            block.nTime    = 1398280909;
            block.nNonce   = 2904701;    /////386402991;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x645d1f944463cdb02e1fb953db6fc4c78a5cb94dc2bca01217c81f51833949d6"));

        // If genesis block hash does not match, then generate new genesis hash.
        if (true && block.GetHash() != hashGenesisBlock) // Wichtig1
        {
